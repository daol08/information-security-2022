...
def sdes(text: bitarray, key: bitarray, mode) -> bitarray:
    ...
    if mode == MODE_ENCRYPT:
        #right harf
        merged4p1 = round(right, k1)
        xor_left1 = merged4p1 ^ left
        ...
        #second
        merged4p2 = round(right, k2)
        xor_left2 = merged4p2 ^ left
        
        
        te = xor_left2 + xor_left1
